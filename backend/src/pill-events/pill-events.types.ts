...
// Typescript types
export type PillEventsInsert = z.infer<typeof pillEventsInsertSchema>;
export type PillEventsSelect = z.infer<typeof pillEventsSelectSchema>;
export type PillStates = z.infer<typeof pillStatesSchema>;
